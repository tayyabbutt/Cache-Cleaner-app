package com.mobxpert.supercleaner.storagecleaner.util;
...
public class CleanUtil {
    ...
    public static void freeAppCache(String packageName) {
    ...
    public static void killAppProcesses(String packageName) {
        ...
        ActivityManager am = (ActivityManager)MyApplication.context
